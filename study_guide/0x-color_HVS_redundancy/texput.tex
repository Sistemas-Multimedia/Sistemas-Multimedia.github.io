\input{../definitions}
\title{\SM{} - Study Guide - Milestone 6: Removing Color Redundancy}
...
The HVS (Human Visual System) is more sensitive to the luminance than
to the chrominance. Therefore, in a lossy video compression system:
\begin{enumerate}
\item The chrominance can be quantized more severely than the
  luminance.
\item The chrominance can be subsampled, although this alternative
  will not be researched because we are, for now, interested only in
  minimizing the RMSE of the reconstructed video.
\end{enumerate}
  
works quite well recognizing the information stored in images (and
