...
\begin{figure}
  ...
  \caption{Daubechies 5 filters's response in the frequency domain
    (see this
    \href{https://github.com/Sistemas-Multimedia/Sistemas-Multimedia.github.io/blob/master/study_guide/05-DWT/dwt_filters_analysis.ipynb}{notebook}).}
  \label{fig:db5_filters_response}
\end{figure}
...
\begin{figure}
  ...
  \caption{Biorthiogonal 3.5 filters's response in the frequency
    domain (see this
    \href{https://github.com/Sistemas-Multimedia/Sistemas-Multimedia.github.io/blob/master/study_guide/05-DWT/dwt_filters_analysis.ipynb}{notebook}).}
  \label{fig:bior3.5_filters_response}
\end{figure}

As it can be seen in the Fig.~\ref{fig:Haar_filters_response}, $K_0$
is a \href{https://en.wikipedia.org/wiki/Low-pass_filter}{low-pass
  filter} and $K_1$ is a
...
\item There exists
  ...
  Figs.~\ref{fig:db5_filters_response} and
  \ref{fig:bior3.5_filters_response}).
...
\item There is not
  ...
  refers to the section of signal $\{l^s_{2n}, l^s_{2n+1}\}$,
  ...
  hold for all filters (see Fig.~\ref{}).
\end{enumerate}
