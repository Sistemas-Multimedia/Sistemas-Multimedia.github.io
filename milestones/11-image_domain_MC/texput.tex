\input{../../definitions}
\title{\SM{} - Study Guide - Milestone 11: Motion Compensation in the Image Domain}
...
estimation and compensation of frames in the image domain.
...
blocks. This supposes an optimization problem that it's hard to solve,
...
negatively to the compression ratio. On the contrary, an adventage of
