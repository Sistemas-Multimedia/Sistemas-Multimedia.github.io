...
different coeffs can be I-type or P-type.
...
\begin{equation}
  \{\hat{V}_k.L, \tilde{E}_k.H\} \leftarrow \text{E}(\hat{V}_k.L, \tilde{E}_k.H),
  \tag{p}
\end{equation}
...
\begin{equation}
  (\hat{V}_k.L, \tilde{E}_k.H) \leftarrow \text{E}^{-1}(\{\hat{V}_k.L, \tilde{E}_k.H\}),
  \tag{q}
\end{equation}
