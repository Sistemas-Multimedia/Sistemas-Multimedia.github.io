...
that in an I-type decomp all the coefficients (\emph{coeffs} in short)
...
bit-rate). However, notice that the use of versions of the decomps at
...
When only spatial scalability is used, this scheme is free of drift-error.
