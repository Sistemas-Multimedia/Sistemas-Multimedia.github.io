...
(you can see the basis functions of several DWT in the
\href{http://wavelets.pybytes.com/}{Wavelet Browser}) defined by a
\href{https://tecnologias-multimedia.github.io/study_guide/12-temporal_coding/}{cascade
...
\begin{figure}
  ...
  \caption{Haar filters's response in the frequency domain (see this
    \href{https://github.com/Sistemas-Multimedia/Sistemas-Multimedia.github.io/blob/master/study_guide/08-DWT/dwt_filters_analysis.ipynb}{notebook}).
...
\begin{figure}
  ...
  \caption{Phase response of the Daubechies-5 filters (see this
    \href{https://github.com/Sistemas-Multimedia/Sistemas-Multimedia.github.io/blob/master/study_guide/08-DWT/dwt_filters_analysis.ipynb}{notebook}). Notice
...
\begin{figure}
  ...
  \caption{Subfig.~(a): the Lena image. Subfig.~(b):
    ...
    this
    \href{https://github.com/Sistemas-Multimedia/Sistemas-Multimedia.github.io/blob/master/milestones/08-2D-DWT/dwt_lena.ipynb}{notebook}.}
...
Please, extend this
\href{https://github.com/Sistemas-Multimedia/Sistemas-Multimedia.github.io/blob/master/milestones/07-DWT/dwt_filters_analysis.ipynb}{notebook} to perform RDO (Rate/Distortion Optimization) in the YCoCg/2D-DWT domain.
