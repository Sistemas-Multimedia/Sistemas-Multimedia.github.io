...
\begin{figure}
  \centering
  \png{stockholm_error}{800}
  \caption{The prediction error frame (${\mathbf R} - {\hat{\mathbf P}}$).}
  \label{fig:error}
\end{figure}

As it can be seen in the Figs \ref{fig:R}, \ref{fig:P}, \ref{fig:MVs},
...
object tracking problems. In the case of video coding, the main disadvantage of such issue is that the entropy of the motion fields arises, which also decreases the compression ratio.
