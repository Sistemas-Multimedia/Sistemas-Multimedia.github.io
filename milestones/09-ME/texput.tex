...
\begin{equation}
  \begin{bmatrix}
    \tilde{\mathbf R} & \tilde{\mathbf E} \\
  \end{bmatrix} =
  \begin{bmatrix}
    \text{Q}(\cdot) & 0 \\
    -\overset{{\mathbf R}\rightarrow {\mathbf P}}{\text{ME}}(\text{Q}(\cdot)) & 1
  \end{bmatrix}
  \begin{bmatrix}
    {\mathbf R } & {\mathbf P}
  \end{bmatrix}
...
\begin{equation}
  \begin{bmatrix}
    \tilde{\mathbf R} & \tilde{\mathbf P} \\
  \end{bmatrix} =
  \begin{bmatrix}
    \text{Q}^{-1}(\cdot) & 0 \\
    \overset{{\mathbf R}\rightarrow {\mathbf P}}{\text{ME}}(\text{Q}^{-1}(\cdot)) & 1
  \end{bmatrix}
  \begin{bmatrix}
    \tilde{\mathbf R} & \tilde{\mathbf E} \\
  \end{bmatrix}
...
defined by the Equations ~\ref{eq:forward} and \ref{eq:backward} are
