...
high-frequency information in the chromas. Thus, compression systems
such as \href{https://en.wikipedia.org/wiki/JPEG}{JPEG} can
...
systems because it helps to quantify the impact of each component on
the quality of the reconstruction of the image in an isolated way
(without considering the rest of components), significantly
simplifying the determination of the pattern of quantization steps
that generate the optimal RD curve. On the other hand,
