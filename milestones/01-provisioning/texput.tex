...
running PRMC) is optional , but it is highly
...
PRMC in a Xubuntu 21.04 (Hirsute Hippo) \cite{xubuntu},
running natively
...
\item At this point of the installation you should consider (depending
  ...
  dedicated partition). Consider also that PRMC requires only some
