...
The \href{https://github.com/Sistemas-Multimedia/MRVC/}{MRVC
  (Multi Resolution Video Codec) project}~\cite{MRVC} is basically a
...
running MRVC) is optional , but it is highly
recommend to do it because you'll give technical support in a reasonable
time in the case you are in trouble. Futhermore, it is recommend to run
MRVC in a Xubuntu 21.04 (Hirsute Hippo) \cite{xubuntu},
running natively
