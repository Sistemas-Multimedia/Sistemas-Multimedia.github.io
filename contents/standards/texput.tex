...
\begin{tabular}{lrrrrrrrrr}
     &              &                          &          &               &         &              & Code-stream & & \\
     &              &                          &          &               &         &              & scalability & & \\
     &              &                          &          &       Maximum &         &      Maximum &  T=temporal & & \\
     &              &                          &          &       spatial & Maximum &          bit &   S=Spatial & & \\
     &     Name of  &                          &          &    resolution & picture &         rate &   Q=Quality & & Lossless \\
Year & the standard & Common encoding pipeline & Main use & (rows x cols) &    rate & (only video) &       R=\href{https://en.wikipedia.org/wiki/Region_of_interest}{ROI} & \href{https://en.wikipedia.org/wiki/Stereoscopy}{Stereo} & option\\
\hline
...
\href{https://mpeg.chiariglione.org/standards/mpeg-2/video}{SQ} & % Scalability
No & % Stereo
No \\ % Lossless
