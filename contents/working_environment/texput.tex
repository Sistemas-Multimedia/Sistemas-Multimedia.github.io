...
\input{../../definitions}
\title{\SM{} - \href{https://sistemas-multimedia.github.io/contents/working_environment}{Working Environment}}
...
Remember that in Windows there exists the posibility of using the
