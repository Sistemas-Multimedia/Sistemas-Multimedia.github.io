...
\href{https://en.wikipedia.org/wiki/Lossless_compression}{lossless
  image compression format} used in this course for representing the
...
\href{https://en.wikipedia.org/wiki/Film_frame}{frames}). In this
context, a frame can be described as a
...
From a mathematical perspective, a frame sequence can be denoted by
\begin{equation*}
...
sequence name and ``.png'' indicates that the frames are coded using
