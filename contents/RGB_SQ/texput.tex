...
of ``redundancy'' removed is the visual redundancy.
...
\begin{equation}
  ...
  \mathbf{\Delta}^{\text{B}}_i, \forall i.
  \label{eq:simple_Q}
\end{equation}
Notice also that any other combination of quantization steps should
generate some bias of the chroma towards one of the basic colors (red,
green and blue).
...
\section{Optimal quantization pattern}
...
\begin{equation}
  ...
  \mathbf{\lambda}^{\text{B}}_i, \forall i
