...
basically are generated by the quantization noise).

Currently, VCF includes (when decoding) the modules
\href{https://github.com/vicente-gonzalez-ruiz/vector_quantization/blob/main/docs/gaussian_blur.ipynb}{gaussian\_blur.ipynb} \cite{gonzalez1992digital},
\href{https://github.com/vicente-gonzalez-ruiz/vector_quantization/blob/main/docs/NLM.ipynb}{NLM.ipynb} \cite{buades2005non},
and
\href{https://github.com/vicente-gonzalez-ruiz/vector_quantization/blob/main/docs/BM3D.ipynb}{BM3D.py}
\cite{dabov2007image}.

\section{References}

\renewcommand{\addcontentsline}[3]{}% Remove functionality of \addcontentsline
\bibliography{quantization,perception,information_theory,data_compression,image_processing,denoising}
