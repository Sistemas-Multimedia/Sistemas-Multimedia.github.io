...
\section{To-Do}
\begin{enumerate}
\item Modify VCF to allow the use of Lloyd-Max Quantization in the compression pipeline.
\item Modify VCF to allow the use of Vector Quantization in the compression pipeline.
\end{emumerate}
