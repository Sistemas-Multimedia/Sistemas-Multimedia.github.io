...
exactly the same input signal. In a orthogonal transfor, the output
...
In terms of energy concentration, for a zero-mean Gaussian sources the KLT is optimal among all orthogonal linear transforms. The mutidimensional KLT is separable.
