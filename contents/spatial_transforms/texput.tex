...
\item Create a new image codec (similar to \texttt{2D-DWT.py}) where
  ...
  coefficients of the filters of a a well-known, and in subsequent
  iterations (levels) of the transform used the previously analyzed
  levels to fine-tune the coefficients.
