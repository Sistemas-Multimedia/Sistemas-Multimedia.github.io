...
matrix of the input data. In terms of energy concentration, for a
zero-mean Gaussian sources the KLT is optimal among all orthogonal
transforms.
...
\section*{To-Do}
VCF includes a Learned Block Transform (LBT) (see \href{https://github.com/Sistemas-Multimedia/VCF/blob/main/notebooks/LBT.ipynb}{LBT}). This is basically the implemented algorithm:
