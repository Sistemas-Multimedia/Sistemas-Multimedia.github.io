...
statistical correlation (and perceptual redundancy\footnote{We will see this later in
this course.}) that the pixels show as a consequence of
the spatial (2D) correlation. For example, some areas of an image can occur
