...
\item \textbf{Learned Block Transform (LBT)}: As other transforms do,
  ...
  4x4, 8x8 and 16x16). Notice that, during inference, the weights of
  the neurons should represents the coefficients of the learned
  transform. Remember that we also need the inverse transform.
\end{enumerate}
