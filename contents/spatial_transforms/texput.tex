...
\begin{enumerate}
  ...
  \item Remove from the code all the part related with the perceptual
    quantization. The QSS matrices are specific for the 2D-DCT.
...
\item
  \href{https://github.com/Sistemas-Multimedia/Sistemas-Multimedia.github.io/blob/master/contents/spatial_transforms/notebooks/learned_transform_autoencoder.ipynb}{Learned
