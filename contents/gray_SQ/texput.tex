...
There are several USQ mapping algorithms to convert $\mathbf{s}$ into
...
which in general is advantagous for lossy compression, specially the
midtread quantizers with deadzone (see
\href{https://github.com/Sistemas-Multimedia/Sistemas-Multimedia.github.io/blob/master/contents/gray_SQ/gray_SQ_deadzone.ipynb}{gray\_SQ\_deadzone.ipynb} and ). As
you can check (see
...
and this fact holds for all the quantizers.
