...
This course introduces and develops some of the most common multimedia
processing techniques. The teaching methodology is based in the
project based learning and such techniques are used to develop an
open-source video
...
\item [Milestone 1: {\normalfont Preparing the working environment.}]
  \emph{In most cases, open source frameworks increase the portability
  of the software and eases the deployment!}
  \begin{description}
  \item [Step 1: {\normalfont
...
data. This milestone analyzes some of the most used lossless image
compressors.}
  \begin{description}
  \item [Task 4: {\normalfont
...
\item [Milestone 3: {\normalfont Quantization in the RGB domain:}]
  \emph{Raw images and videos contain significant amounts of information
  that can be removed without generating a high visual distortion. The
  basic technique to delete information in signals is called
  quantization}.
  \begin{description}
  \item [Task 8: {\normalfont
...
\item [Milestone 7: {\normalfont Motion estimation and compensation in
    the transform domain:}] \emph{When the transform of an image
generates a multiresolution representation it is possible to perform
motion estimation and compensation in the transform domain}.
  \begin{description}
  \item [Task 18: {\normalfont
