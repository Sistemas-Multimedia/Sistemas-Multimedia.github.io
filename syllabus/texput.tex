...
(and in signals in general)}.
 ...
 artifacts}.
   \begin{description}
   \item [Task 1: {\normalfont
       \href{https://sistemas-multimedia.github.io/contents/RGB_DCT_SQ/}{Using
         the DCT (Discrete Wavelet Transform) in the $\text{RGB}$ color domain.}}]
   \item [Task 2: {\normalfont
       \href{https://sistemas-multimedia.github.io/contents/YCoCg_SQ/}{Using the 
         YCoCg (luminance, orange chroma, green chroma)}.}]
   \item [Task 3: {\normalfont
       \href{https://sistemas-multimedia.github.io/contents/YCrCb_SQ/}{Using the
         YCrCb (luminance, red chroma, blue chroma)}.}]
   \item [Task 4: {\normalfont
       \href{https://sistemas-multimedia.github.io/contents/RCT_SQ/}{Using the
         \href{https://en.wikipedia.org/wiki/JPEG_2000\#Color_components_transformation}{RCT
           (Reversible Color Transform) domain}}. TO-DO.}]
   \item [Task 4: {\normalfont
       \href{https://sistemas-multimedia.github.io/contents/LMS_SQ/}{Using the
...
compression ratios}.
  ...
  \item [Task 3: {\normalfont
      \href{https://sistemas-multimedia.github.io/contents/gray_VQ/}{Spatial
        Decorrelation with Vector Quantization}.}] % Podemos aplicar spatial-VQ a la imagen color-VQ-ed
  \end{description}
  ~\newline
