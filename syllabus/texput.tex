...
(and in signals in general)}.
  ...
  \item [Task 4: {\normalfont
      \href{https://sistemas-multimedia.github.io/contents/RGB_SQ/}{Scalar quantization in the $\text{RGB}$ color domain}.}]
  \item [Task 5: {\normalfont
      \href{https://sistemas-multimedia.github.io/contents/color_VQ/}{Vector
 ...
 \item [Milestone 4: {\normalfont Exploiting RGB color redundancy with transforms:}]
  ...
  \begin{description}
  \item [Task 1: {\normalfont
      \href{https://sistemas-multimedia.github.io/contents/color_DCT/}{Using the Color-DCT (Discrete Cosine Transform)}.}]
  \item [Task 2: {\normalfont
