 ...
 artifacts}.
   ...
   \item [Task 1: {\normalfont
       \href{https://sistemas-multimedia.github.io/contents/RGB_DCT_SQ/}{Using
         the DCT in the $\text{RGB}$ color domain.}}]
   \item [Task 2: {\normalfont
...
compression ratios}.
  ...
  \item [Task 1: {\normalfont
      \href{https://sistemas-multimedia.github.io/contents/gray_VQ/}{Vector
        quantization of gray-scale images}. -> Block-based spatial vector quantization.}] % Podemos aplicar spatial-VQ a la imagen color-VQ-ed 
  \item [Task 2: {\normalfont
