...
removed without generating a meaningful visual distortion. For this
task, we will use Scalar Quantization, a basic basic technique that
allows to remove information in images and videos (and in signals in
general)}.
  \begin{description}
  \item [Task 1: {\normalfont
